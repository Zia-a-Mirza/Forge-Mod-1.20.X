...
public enum ModArmorMaterials implements ArmorMaterial {
    CHLOROPHYTE("chlorophyte", 40, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 4);
        p_266655_.put(ArmorItem.Type.LEGGINGS, 7);
        p_266655_.put(ArmorItem.Type.CHESTPLATE, 8);
        p_266655_.put(ArmorItem.Type.HELMET, 3);
    }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.of(ModItems.Chlorophyte_Ingot.get()));
    ...
    public String getName() {
        return SunkenBiomes.MOD_ID + ":" + this.name;
    }
